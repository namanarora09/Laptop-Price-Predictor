...
# Load data
DATA_PATH1 = os.path.join(FILE_DIR, "laptop_price.csv")
...
MODEL_PATH=os.path.join(FILE_DIR,"laptop_price_prediction_model.pkl")
...
if st.button('Predict'):
    ...
    st.subheader(":blue[Laptop Price For Your Selected Feature :] :green[{}]".format(
        "₹"+str(price)))
else:
    pass
